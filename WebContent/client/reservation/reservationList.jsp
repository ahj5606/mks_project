...
<script type="text/javascript">
 ...
 function popup_board(){
    alert("공지사항목록 팝업!");
    cmm_window_popup('/mks_project/client/reservation/boardList.jsp?hp_name='+$("#h_name").val(),'1200','800','공지사항');
 }
...
<body>
   ...
   <nav class="navbar navbar-expand-lg navbar-light" style="background-color:#007bff;">
       <%-- <a class="navbar-brand" href="#"><%if(hp_name!=null){ out.print(hp_name); }%></a>
            ...
            <div class="row pt-2">
               <div class="col-md">
                  <div class="input-group">
                        <input type="text" class="form-control" id="h_name" name="h_name" type="search" placeholder="Ex) 고길동">
