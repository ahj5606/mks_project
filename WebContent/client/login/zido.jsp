...
<body>
<input type="text" id="sample5" placeholder="여기">
<input type="text" id="sample5_address" placeholder="주소">
<input type="text" id="sample1" placeholder="1">
<input type="button" onclick="sample5()" value="주소 검색"><br>
    ...
    function sample5() {
        ...
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                document.getElementById("sample5").value = addr1;
                document.getElementById("sample1").value = addr2;
