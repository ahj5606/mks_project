					...
					<div class="row" style="border: 0px solid #ccc;">
						<div class="col-sm-2" id="sticky-sidebar">
							...
							<div class="col-xs-1 text-center m-2">
								...
								<button class="btn btn-outline-success" onclick="r_search()"
									value="sdate">날짜 검색 실행</button>
							</div>
...
function r_search(){
	...
	//날짜를 yyyy-mm-dd에서 yyyy/mm/dd로
	//alert("r_name doc_name"+r_name+","+doc_name+","+dept+", 날짜들:"+s_date+","+e_date);
		
	/* if(s_date==null && e_date==null){
	}else if(s_date!=null && e_date!=null){
	location.href="./reserveSEL.mgr?hp_code=< %=hp_code%>&dept_name="+dept+"&mem_name="+r_name+"&doc_name="+doc_name+"&startDate="+s_date+"&endDate="+e_date;		
		
	}else{
		alert("검색할 날짜 구간을 정확히 해주세요.");
	} */
